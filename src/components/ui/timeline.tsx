      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          ...
          >
            ...
            {/* Contenu Desktop */}
            <div className="hidden md:block relative pl-4 w-full">
              {item.content}
            </div>
          </div>
        ))}

        {/* Ligne de timeline - cachée sur mobile */}
        <div
          style={{
            height: height + "px",
          }}
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-t from-[#84994F] via-[#84994F] to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
