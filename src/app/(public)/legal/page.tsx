...
export const metadata: Metadata = {
  ...
  description:
    "Mentions légales et conditions générales des Campings Potentille",
};
    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <section className="mb-12">
        ...
        <div className="bg-gray-50 p-6 rounded-lg space-y-2">
          ...
          <p>
            <strong>Siège social :</strong> L'Etrey 81, 1643 Gumefens, Suisse
          </p>
          <p>
            <strong>Numéro IDE :</strong> CHE-217.3.535.254-7
          </p>
          <p>
            <strong>Email :</strong>{" "}
            <a
      ...
      <section className="mb-12">
        ...
        <div className="prose max-w-none">
          <p className="mb-4">
            Conformément à la législation suisse sur le commerce électronique
            (LCEl), vous disposez d'un droit de rétractation de{" "}
            <strong>14 jours</strong> à compter de la confirmation de votre
            réservation.
          </p>
          ...
          <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mb-4">
            ...
            <p>
              En cas de rétractation dans le délai légal, nous vous
              rembourserons l'intégralité des sommes versées dans un délai de{" "}
              <strong>14 jours</strong> suivant la réception de votre demande de
              rétractation.
            </p>
          </div>
          ...
          <p className="mb-4">
            Le droit de rétractation ne s'applique pas aux réservations dont la
            date d'arrivée est prévue dans un délai inférieur à 14 jours. Dans
            ce cas, nos conditions d'annulation standard s'appliquent.
          </p>
        </div>
      </section>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-6">
          <div>
            ...
            <p>
              Les réservations sont confirmées dès réception du paiement
              complet. Une confirmation vous sera envoyée par email avec tous
          ...
          <div>
            ...
            <p>
              Vos données personnelles sont traitées conformément à la Loi
              fédérale sur la protection des données (LPD) et au Règlement
          ...
          <div>
            <h3 className="text-xl font-semibold mb-3">
              5. Règlement du camping
            </h3>
            <p>
              Les campeurs s'engagent à respecter le règlement intérieur du
              camping qui leur sera communiqué lors de l'arrivée.
            </p>
          </div>
        </div>
      </section>
