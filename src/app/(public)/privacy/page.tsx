    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div className="prose max-w-none">
        <p className="text-lg mb-8">
          La protection de vos données personnelles est une priorité pour Campings Potentille. 
        ...
        <section className="mb-8">
          ...
          <div className="bg-gray-50 p-4 rounded">
            <p><strong>Campings Potentille SA</strong></p>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">Nous collectons les données suivantes lors de votre réservation:</p>
          <ul className="list-disc pl-6 space-y-2">
            <li><strong>Données d'identification:</strong> nom, prénom, date et lieu de naissance</li>
            <li><strong>Coordonnées:</strong> email, téléphone, adresse postale</li>
            <li><strong>Informations de séjour:</strong> dates, nombre de personnes, véhicule</li>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li><strong>Contrat:</strong> nécessaire à l'exécution de votre réservation</li>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li><strong>Stripe:</strong> notre prestataire de paiement sécurisé (certifié PCI-DSS)</li>
            <li><strong>Autorités:</strong> sur demande légale (fiscale, police, etc.)</li>
          </ul>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li><strong>Données de réservation:</strong> 10 ans (obligation comptable)</li>
            <li><strong>Données marketing:</strong> jusqu'à votre désinscription</li>
            <li><strong>Données de paiement:</strong> conservées par Stripe selon leurs règles</li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="bg-gray-50 p-4 rounded mt-4">
            ...
            <p>Email: <a href="mailto:info@potentille.ch" className="text-blue-600 hover:underline">info@potentille.ch</a></p>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">Nous mettons en œuvre des mesures de sécurité appropriées:</p>
          <ul className="list-disc pl-6 space-y-2">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">Notre site utilise des cookies essentiels pour:</p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Maintenir votre session de réservation</li>
            <li>Sécuriser vos transactions</li>
            <li>Améliorer l'expérience utilisateur</li>
          </ul>
          <p className="mt-4">Vous pouvez désactiver les cookies dans votre navigateur, mais cela peut affecter certaines fonctionnalités.</p>
        </section>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">10. Modifications</h2>
          <p>
            Nous nous réservons le droit de modifier cette politique. Les modifications 
            seront publiées sur cette page avec la date de mise à jour.
          </p>
        </section>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">11. Contact et réclamations</h2>
          <p className="mb-4">Pour toute question ou réclamation concernant vos données:</p>
          <div className="bg-gray-50 p-4 rounded">
            <p><strong>Email:</strong> <a href="mailto:info@potentille.ch" className="text-blue-600 hover:underline">info@potentille.ch</a></p>
            <p><strong>Téléphone:</strong> +41 (0)79 695 45 22</p>
          </div>
          <p className="mt-4">
